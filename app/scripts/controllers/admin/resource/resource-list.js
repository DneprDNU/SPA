...
angular.module('dnuApp')
  .controller('ResourceAdminListCtrl', function ($scope, $location, $routeParams, restResources, restResource) {
    ...
    $scope.deleteResource = function (resourceId) {
      restResource.delete({ id: resourceId }, function(){
    ...
    if ($routeParams.page !== undefined) {
      ...
      $scope.resources = restResources.admin_list({from: from, to: to});
    }
    else {
      $scope.resources = restResources.admin_list({from: 0, to: 10});
    }
